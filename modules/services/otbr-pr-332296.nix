  ...
  nixpkgs.overlays = [
    (_: prev: {
      openthread-border-router = 
        let
          inherit (prev) lib stdenv fetchFromGitHub cmake pkg-config systemdLibs avahi dbus protobuf jsoncpp boost libnetfilter_queue libnfnetlink nodejs buildNpmPackage;
          pname = "ot-br-posix";
